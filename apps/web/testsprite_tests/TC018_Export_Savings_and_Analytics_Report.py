...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Export Successful: Savings and Analytics Report').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The export functionality did not complete successfully. The report file did not download with the correct data and format as expected in the test plan.")

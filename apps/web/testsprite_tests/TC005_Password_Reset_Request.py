...
async def run_test():
    ...
    try:
        ...
        # -> Click on Login to go to login page where forgot password link is expected.
        ...
        # -> Input registered email 'omkarkolhe912@gmail.com' and click 'Send Reset Link' button.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click on 'Send Reset Link' button to submit password reset request
        ...
        await expect(frame.locator('text=We\'ve sent a password reset link to omkarkolhe912@gmail.com. Please check your inbox and follow the instructions.').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=Back to Login').first).to_be_visible(timeout=30000)

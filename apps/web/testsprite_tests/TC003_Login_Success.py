...
async def run_test():
    ...
    try:
        ...
        # -> Input valid email and password and click Sign In button
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login was not successful with correct credentials as expected. The user was not redirected to onboarding or dashboard.')

...
async def run_test():
    ...
    try:
        ...
        # -> Click on the Login link to start authentication flow.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Monthly Bill Fetch Successful').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: Monthly bills were not auto-fetched via BBPS API or not displayed correctly in the dashboard as per the test plan.")
